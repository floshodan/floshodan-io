...
export default function Pre({ className, ...props }: IPre) {
  ...
  return (
    <div ref={textInput} className="relative group code">
      <button
        aria-label="Copy code"
        type="button"
        className={clsxm(
          "absolute right-3 bottom-3 z-50 h-9 w-9 rounded border bg-slate-900 p-1 hover:bg-slate-700 hidden group-hover:block",
          copied
